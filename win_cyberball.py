...
def LS(l_face, r_face):
    animation(LS_image_stim, l_face, r_face, anim_frame_duration, randomize_first_frame=True)

def LR(l_face, r_face):
    animation(LR_image_stim, l_face, r_face, anim_frame_duration, randomize_first_frame=True)

def RS(l_face, r_face):
    animation(RS_image_stim, l_face, r_face, anim_frame_duration, randomize_first_frame=True)

def RL(l_face, r_face):
    animation(RL_image_stim, l_face, r_face, anim_frame_duration, randomize_first_frame=True)

def SL(l_face, r_face):
    animation(SL_image_stim, l_face, r_face, anim_frame_duration, randomize_first_frame=False)

def SR(l_face, r_face):  
    animation(SR_image_stim, l_face, r_face, anim_frame_duration, randomize_first_frame=False)
